...
if ((gateway=="Select" || gateway=="") && user_name=="" && destination_user_name=="" && source_host=="" && service=="Select" && direction=="Select" && am_status_code=="Select" && loginDate=="Select" && fromDate=="" && toDate=="" && logoutDate=="Select"  && logoutFromDate=="" && logoutToDate=="") {
...
<table border="0" width="100%" id="table1" height="322" cellspacing="0">
	...
	<tr>
		...
		<td width="83%" align=center height="21">
            ...
            <p align="left"><font color="#800000"><b>DESTINATION HOST LOAD</b></font></td>
	</tr>
	<tr>
		<td width="1%" align=center height="21">
	...
	<tr>
		...
		<td width="83%" align=center height="21" valign="top">
           ...
           <form method="POST" action="destination_host_load.php" name="historyForm">
				...
				<td width="99%" height="28" colspan="2">
					<table border="0" width="100%" id="table24" cellspacing="3" cellpadding="2">
						...
						<tr>
							...
							Direction</font></td>
							<td width="23%">
							<font face="Verdana" size="1"><select size="1" name="direction">
							<option value="Select">Select</option>
	...
	<tr>
		...
		<td width="83%" align=center height="21" valign="top">
           ...
           <b><font face="Verdana" size="2" color="#008000">Destination host Load for 
			current logins------- 
	...
	<tr>
		...
		$rs= $con->viewGatewayLoad($gateway_name,$user_name,$destination_user_name,$source_host,"",$service,"Incoming",$am_status_code,"lastyear",$toDate,$logoutFromDate,$logoutToDate,"ON","RH.host_name",$cn);
        $_SESSION["loginStatus"]="ON";
		$num = mysql_num_rows($rs);
		if ($num>0) {
				if (isset($_GET['gt'])) {
					$graph_type = $_GET["gt"];
					$con->generateChart("destination_host_load",$graph_type,$chart_path,$rs,$graph_file_name,$cn);
					if ($graph_type =="pie_chart") {
						$polyFile='polygons_points/destination_host_load_points.php';
						$_SESSION["polyFile"]="pie";
					}
				else {
						$polyFile='polygons_points/destination_host_load_bar_points.php';
						$_SESSION["polyFile"]="bar";
					}
		}
	else {
			$polyFile='polygons_points/destination_host_load_points.php';
			$con->generateChart("destination_host_load","pie_chart",$chart_path,$rs,$graph_file_name,$cn);
		}
}
$_SESSION['destination_host_url']="destination_host_load_criteria.php";
           ...
           <table border="1" width="90%" style="border-collapse: collapse" bordercolor="#D7D1E4" id="table25">
			<tr>
				<td colspan="2" background="images/15-green.jpg" height="23">
					<font size="1" face="Verdana"><b>
					Destination Host Load Statistics&nbsp; </b></font></td>
			</tr>
			<tr>
				...
				<td>
					...
					<div align="center">
						...
						<table border="0" width="100%" id="table33" cellpadding="3">
								<tr>
								<td align="center" width="53%" background="../images/15.jpg" colspan="2">
								<b><font face="Verdana" size="2">Destination 
								Hosts</font></b></td>
								<td align="center" width="42%" background="../images/15.jpg" colspan="2">
								<b><font face="Verdana" size="2">No. of 
							...
							$countT = $countT + $row["count"];


							?>
							<tr>
								<td align="left" width="5%"></td>
								<td align="left" width="48%"><font face="Verdana" size="2"><a href="destination_host_detail_graph.php?criteria=direction:Incoming,from:lastyear&dest_id=<?php echo $row[remote_host];?>"><?php echo $row[remote_host];?></a></font></td>
							...
							<tr>
								<td align="left" width="5%"></td>
								<td align="left" width="35%"><font face="Verdana" size="2"><a href="destination_host_detail_graph.php?criteria=direction:Incoming,from:lastyear&dest_id=Others">Others</a></font></td>
							...
							<tr>
								...
								<td align="center" width="12%"></td>
								<td align="left" width="38%"><font face="Verdana" size="2"><?php echo $countT;?></font></td>
							</tr>
