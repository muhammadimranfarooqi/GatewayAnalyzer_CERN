...
$criteria =$criteria1.",destination_host:".$dest_id;
...
//echo $flag;
 if ($flag=="false") {
	...
	$con->generateDetailChart("destination_host_load",$dest_id,$chart_path,$rs,$cn);
	$polyFile='polygons_points/destination_host_detail_bar_points.php';
	}
}
$_SESSION["dest_detail"]=$_SERVER['REQUEST_URI'];
$_SESSION['gw_count']=1;
$total=0;
?>
<html>
		...
		<table border="0" width="100%" id="table17" cellspacing="0">
			<tr>
				<td background="images/15-green.jpg" width="48%" height="28">
					...
					Destination <blink>(<?php echo $dest_id;?>)</blink> Load Per Month Statistics&nbsp; </b>(<img border="0" src="images/back_arrow.jpg" width="9" height="12">
					<a style="text-decoration: none" href='<?php echo $_SESSION["destination_host_url"];?>'>Back to 
					Main View</a>)</font></td>
					...
					<div align="center">
						<table border="0" width="100%" id="table34" cellpadding="3">
							...
							<tr>
								...
								<td align="left" width="35%"><font face="Verdana" size="2"><a href="destination_host_load_details.php?criteria=<?php echo $link_text?>&id=<?php echo $firstCol;?>"><?php echo $firstCol;?></a></font></td>
