...
if ($_SESSION["user_url"]=="user_load_criteria.php") 
...
for ($i=0;$i<$count;$i++) {
$j=1;
foreach($_SESSION["top_ten_users_load_point".$i] as $key=>$value)
    {
    if ($j==1) {
			$poly_string = $value;
			} 
 ...
 echo "<area shape=POLY coords=\"$poly_string\" title='$labelName' href='top_ten_users_detail_graph.php?criteria=$link_text&user_name=$labelName'>";
}  
echo "</map>";
?>
<p>
