...
if (user_name=="" && destination_user_name==""  && source_host=="" && destination_host=="" && (gateway=="Select" || gateway=="") && direction=="Select" && am_status_code=="Select"  && loginDate=="Select" && fromDate=="" && toDate=="" && logoutDate=="Select" && logoutFromDate=="" && logoutToDate=="") {
...
<table border="0" width="100%" id="table1" height="322" cellspacing="0">
	...
	<tr>
		...
		<td width="83%" align=center height="21" valign="top">
           ...
           <form method="POST" action="service_load.php" name="historyForm">

		<input type="hidden" name="am_status_code_text" size="20">

		<input type="hidden" name="service_text" size="20">
		...
		<table border="0" width="100%" id="table23" cellpadding="2" cellspacing="0">
			<tr>
				<td background="images/15-green.jpg" width="56%" height="28">
					<font size="1" face="Verdana"><b>
					Select Criteria to Search Statistics on Service 
					basis </b></font></td>
				<td background="images/15-green.jpg" width="43%" height="28">
		&nbsp;</td>
				</tr>
			<tr>
				<td width="99%" height="28" colspan="2">
					<table border="0" width="100%" id="table24" cellspacing="3" cellpadding="2">
						<tr>
							<td width="21%"><font face="Verdana" size="1">
							Gateway</font></td>
							<td width="27%" colspan="2">
							<select size="1" name="gateway" onchange="javascript:document.historyForm.gateway_name.value=this[this.selectedIndex].text;">
							...
							?>
								...
								<input type="hidden" name="gateway_name" size="20"></td>
							<td width="25%">&nbsp;</td>
							<td width="31%">
						...
						<tr>
							<td width="21%"><font face="Verdana" size="1">Source User</font></td>
							<td width="27%" colspan="2">
							
							
								<input type="text" name="user_name" size="20"></td>
						...
						<tr>
							<td width="21%"><font face="Verdana" size="1">Source 
							Host</font></td>
							<td width="27%" colspan="2">
						...
						<tr>
							<td width="21%"><font face="Verdana" size="1">
							Direction</font></td>
							<td width="27%" colspan="2"><select size="1" name="direction">
							<option value="Select">Select</option>
							<option value="Incoming" selected>Incoming</option>
							<option value="Outgoing">Outgoing</option>
							</select></td>
							<td width="25%"><font face="Verdana" size="1">AM 
							Status Code</font></td>
							<td width="31%">
						...
						<tr>
							<td width="21%"><font face="Verdana" size="1">Login 
							Date</font></td>
							<td width="27%" colspan="2">
							...
							<td width="25%">&nbsp;</td>
							<td width="31%"><font face="Verdana" size="1">
						...
						<tr id="loginDateRow"  <?php if ($_SESSION["gloginDate"]!="Custom") { ?> style="display:none" <?php } ?> >
							<td width="21%"><font face="Verdana" size="1">Login Date 
							Range</font></td>
						...
						<tr style="display:none" id="logoutDateRow">
							<td width="21%"><font face="Verdana" size="1">Logout Date 
							Range</font></td>
							<td width="21%"><font size="1" face="Verdana">
	...
	<tr>
		...
		<td width="83%" align=center height="21" valign="top">
          ...
          <b><font face="Verdana" size="2" color="#008000">Service Load for 
			current logins------- 
			Direction : </font><font face="Verdana" size="2" color="#FF0000">
			Incoming</font><font color="#008000" face="Verdana" size="2"> for
			</font><font face="Verdana" size="2" color="#FF0000">Last 1 Year</font><font color="#008000" face="Verdana" size="2"> 
	...
	<tr>
		...
		<td width="83%" align=center height="21" valign="top">
		<?php 
		$rs= $con->viewGatewayLoad($gateway_name,$user_name,$destination_user_name,$source_host,$destination_host,"","Incoming",$am_status_code,"lastyear",$toDate,$logoutFromDate,$logoutToDate,"ON","services.name",$cn);
		$_SESSION["loginStatus"]="ON";
		$num = mysql_num_rows($rs);
		if ($num>0) {
				if (isset($_GET['gt'])) {
					$graph_type = $_GET["gt"];
					$con->generateChart("service_load",$graph_type,$chart_path,$rs,$graph_file_name,$cn);
					if ($graph_type =="pie_chart") {
						$polyFile='polygons_points/service_load_points.php';
						$_SESSION["polyFile"]="pie";
					}
				else {
						$polyFile='polygons_points/service_load_bar_points.php';
						$_SESSION["polyFile"]="bar";
					}
		}
	else {
			$polyFile='polygons_points/service_load_points.php';
			$con->generateChart("service_load","pie_chart",$chart_path,$rs,$graph_file_name,$cn);
		}
}
$_SESSION["sv_url"]="service_load_criteria.php";
		?>
			...
			<tr>
				<td colspan="2" background="images/15-green.jpg" height="23">
					<font size="1" face="Verdana"><b>
					Service Load Statistics&nbsp; </b></font></td>
			</tr>
			<tr>
...
No. of Users</font></b></td>
						...
						$link_text = $_SESSION["link_text"];
							...
							<tr>
								...
								<td align="left" width="35%"><font face="Verdana" size="2"><a href='service_detail_load_graph.php?criteria=<?php echo "direction:Incoming,from:lastyear";?>&sv=<?php if ($row["name"]=="") echo "Others"; else echo $row["name"];?>'><?php if ($row["name"]=="") echo "Others"; else echo $row["name"];?></a></font></td>
