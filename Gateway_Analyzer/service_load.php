...
if ($loginDate=="lastday" or $loginDate=="lastweek" or $loginDate=="lastmonth" or $loginDate=="lastyear") {
	...
	if ($search_text=="") {
		...
		$search_text = $search_text ." and for login <font color=limegreen>".$loginDate."</font>";
...
$_SESSION["sv_url"]="service_load.php";
?>
<html>
...
<table border="0" width="100%" id="table1" height="302" cellspacing="0">
	<tr>
	...
	<tr>
		<td width="1%" align=center height="49" valign="top">
		
           
		
</td>
		<td width="83%" align=center height="49" valign="top">
		
          <p align=center><?php echo "<font face=verdana size=2 color=blue><b>$search_body</b></font>";?></p>

		<table border="1" width="100%" style="border-collapse: collapse" id="table28" bordercolor="#D7D1E4">
			<tr>
				<td>
		...
		<div align="left">
			<table border="0" width="100%" style="border-collapse: collapse" id="table30" cellspacing="2" cellpadding="3">
				<tr>
					<td background="images/15-green.jpg"><b>
					<font size="1" face="Verdana">Service Load Statistics </font></b>
					<font size="1" face="Verdana"><b>
					&nbsp;</b><font color="#008000">(</font></font><font size="1" face="Verdana" color="#008000">View 
					As :- </font>
					<a href="javascript:getProperGraph('pie_chart','service_load')">
					<img border="0" src="images/chart_pie.png" width="16" height="16"></a><font size="1" face="Verdana" color="#008000"> 
					or </font>
					<a href="javascript:getProperGraph('bar_chart','service_load')">
					<img border="0" src="images/chart_bar.png" width="16" height="16"></a><font size="1" face="Verdana" color="#008000"> 
					)</font></td>
					<td background="images/15-green.jpg">&nbsp;</td>
				</tr>
				<tr>
					<td colspan="2">
		<div id="mainDiv">
          
				<?php include 'service_load_graph.php';
				?>
				</div>
		</td>
				</tr>
