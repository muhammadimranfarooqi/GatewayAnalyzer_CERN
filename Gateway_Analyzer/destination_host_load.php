...
$_SESSION["gateway_name"] =  $gateway_name; 
...
if ($gateway_name!="" && $gate_name!="Select") {
	if ($search_text=="") {
		$search_text = "gateway : <font color=limegreen> $gateway_name</font>";
		$link_text = "gateway:$gateway_name";

		}
	else {
		$search_text = $search_text ." and gateway : <font color=limegreen>$gateway_name</font>";
		$link_text = $link_text .",gateway:$gateway_name";
		}
	if ($graph_file_name!="")
		$graph_file_name=$graph_file_name.",".$gateway_name;
	else 
		$graph_file_name=$gateway_name;
...
$_SESSION['destination_host_url'] = "destination_host_load.php";
	...
	<tr>
		...
		<div align="left">
			<table border="0" width="100%" style="border-collapse: collapse" id="table18" cellspacing="2" cellpadding="3">
				<tr>
					<td background="images/15-green.jpg" height="29"><b>
					<font size="1" face="Verdana">Destination Host Load Statistics&nbsp; </font></b>
					<font color="#008000" size="1" face="Verdana">&nbsp;(View 
					As :- </font>
					<a href="javascript:getProperGraph('pie_chart','destination_host_load')">
					<img border="0" src="images/chart_pie.png" width="16" height="16"></a><font size="1" face="Verdana" color="#008000"> 
					or </font>
					<a href="javascript:getProperGraph('bar_chart','destination_host_load')">
					<img border="0" src="images/chart_bar.png" width="16" height="16"></a><font size="1" face="Verdana" color="#008000"> 
					</font></td>
					<td background="images/15-green.jpg" height="29">&nbsp;</td>
				</tr>
				<tr>
					<td colspan="2">
		<div id="mainDiv">
          
				<?php include 'destination_host_load_graph.php';
				?>
				</div>
		</td>
				</tr>
