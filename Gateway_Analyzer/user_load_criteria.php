...
if ((gateway=="Select" || gateway=="") && destination_user_name=="" && source_host=="" && destination_host=="" && service=="Select" && direction=="Select" && am_status_code=="Select" && loginDate=="Select" && fromDate=="" && toDate=="" && logoutDate=="Select" && logoutFromDate=="" && logoutToDate=="") {
	alert("Please enter some criteria")
	document.historyForm.destination_user_name.focus()
	return false;
}
if (loginDate=="Custom") {
	if (fromDate=="" || toDate=="") {
...
<table border="0" width="100%" id="table1" height="322" cellspacing="0">
	...
	<tr>
		...
		<td width="83%" align=center height="21">
            ...
            <p align="left"><font color="#800000"><b>USER LOAD</b></font></td>
	</tr>
	<tr>
		<td width="1%" align=center height="21">
	...
	<tr>
		...
		<td width="83%" align=center height="21" valign="top">
           ...
           <form method="POST" action="user_load.php" name="historyForm">
	...
	<tr>
		...
		<td width="83%" align=center height="21" valign="top">
           ...
           <b><font face="Verdana" size="2" color="#008000">Top Ten Users Load for 
			current logins------- 
	...
	<tr>
		...
		$rs= $con->viewGatewayLoad($gateway_name,"",$destination_user_name,$source_host,$destination_host,$service,"Incoming",$am_status_code,"lastyear",$toDate,$logoutFromDate,$logoutToDate,"ON","SU.user_name",$cn);
        $_SESSION["loginStatus"]="ON";
		$num = mysql_num_rows($rs);
		if ($num>0) {
				if (isset($_GET['gt'])) {
					$graph_type = $_GET["gt"];
					$con->generateChart("top_ten_users",$graph_type,$chart_path,$rs,$graph_file_name,$cn);
					if ($graph_type =="pie_chart") {
						$polyFile='polygons_points/top_ten_users_points.php';
						$_SESSION["polyFile"]="pie";
					}
				else {
						$polyFile='polygons_points/top_ten_users_bar_points.php';
						$_SESSION["polyFile"]="bar";
					}
		}
	else {
			$polyFile='polygons_points/top_ten_users_points.php';
			$con->generateChart("top_ten_users","pie_chart",$chart_path,$rs,$graph_file_name,$cn);
		}
}
$_SESSION['user_url']="user_load_criteria.php";
           ...
           <table border="1" width="90%" style="border-collapse: collapse" bordercolor="#D7D1E4" id="table25">
			<tr>
				<td colspan="2" background="images/15-green.jpg" height="23">
					<font size="1" face="Verdana"><b>
					User Load Statistics&nbsp; </b></font></td>
			</tr>
			<tr>
				...
				<td>
					...
					<div align="center">
						...
						<table border="0" width="100%" id="table33" cellpadding="3">
								...
								<b><font face="Verdana" size="2">User</font></b></td>
								<td align="center" width="50%" background="images/15.jpg" colspan="2">
							...
							<tr>
								...
								<td align="left" width="35%"><font face="Verdana" size="2"><a href="top_ten_users_detail_graph.php?criteria=direction:Incoming,from:lastyear&user_name=<?php echo $row[source_user];?>"><?php echo $row["source_user"];?></a></font></td>
							...
							<tr>
								<td align="left" width="5%"></td>
								<td align="left" width="35%"><font face="Verdana" size="2"><a href="top_ten_users_detail_graph.php?criteria=<?php echo $link_text;?>&user_name=Others">Others</a></font></td>
								<td align="center" width="12%"></td>
