...
if ($destination_host!="") {
	...
	if ($graph_file_name!="")
		$graph_file_name=$graph_file_name.",".$destination_host;
	else 
		$graph_file_name=$destination_host;
...
$_SESSION['direction_url'] = "direction_load.php";
...
<table border="0" width="100%" id="table1" height="802" cellspacing="0">
	...
	<tr>
		...
		<div align="left">
			<table border="0" width="100%" style="border-collapse: collapse" id="table18" cellspacing="2" cellpadding="3">
				<tr>
					...
					<font size="1" face="Verdana">Direction Load Statistics </font></b>
					<font color="#008000" size="1" face="Verdana">&nbsp;(View 
					As :- </font>
					<a href="javascript:getProperGraph('pie_chart','direction_load')">
					<img border="0" src="images/chart_pie.png" width="16" height="16"></a><font size="1" face="Verdana" color="#008000"> 
					or </font>
					<a href="javascript:getProperGraph('bar_chart','direction_load')">
		...
		<div id="mainDiv">
				...
				<?php include 'direction_load_graph.php';
				?>
				</div>
		</td>
				</tr>
