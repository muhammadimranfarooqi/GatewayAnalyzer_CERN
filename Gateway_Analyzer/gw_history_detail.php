...
$TRecord = $con->viewGatewayHistoryLoadByMonth($criteria,$id,$sort,$how,$cn);
...
<table border="0" width="100%" id="table1" height="695" cellspacing="0">
	...
	<tr>
		...
		<td width="83%" align=center height="1" colspan="5">
            ...
            <p align="left"><font color="#800000"><b>STATISTICS LOAD   <font color=green>(<?php echo $criteria;?> in <?php echo $id?>)</font></b></font></td>
	</tr>
	<tr>
		<td width="1%" align=center height="1">
...
if ($RecordCount>0) {
 ...
 $result = $con->viewGatewayHistoryLoadByMonthSpecificPage($criteria,$id,$sort,$how,$StartRow,$PageSize,$cn);
?>
  ...
  <tr>
    <td>
      ...
      //  if($CounterStart != 1){
          if ($PageNo!=1)
            $PrevStart = $PageNo - 1;
          	...
          	$PrevStart = 1;
            print "<a href='gw_history_detail.php?PageNo=1&sort=$sort&how=$np&totalpages=$PageSize&criteria=$criteria&id=$id'> << First </a> : ";
            print "<a href='gw_history_detail.php?PageNo=$PrevStart&sort=$sort&how=$np&totalpages=$PageSize&criteria=$criteria&id=$id'> < Previous </a>";
      //  }
        print " [ ";
        $c = 0;
        ...
        for($c=$CounterStart;$c<=$CounterEnd;$c++){
            if($c < $MaxPage){
                if($c == $PageNo){
                    ...
                    echo "<a href='gw_history_detail.php?PageNo=$c&sort=$sort&how=$np&totalpages=$PageSize&criteria=$criteria&id=$id'>$c</a> ";
                }else{
                    echo "<a href='gw_history_detail.php?PageNo=$c&sort=$sort&how=$np&totalpages=$PageSize&criteria=$criteria&id=$id'>$c</a> ,";
                }//END IF
            }else{
      ...
      if($PageNo < $MaxPage)
          ...
          echo "<a href='gw_history_detail.php?PageNo=$NextPage&sort=$sort&how=$np&totalpages=$PageSize&criteria=$criteria&id=$id'>Next > </a> : ";
     // }
    ...
    //  if($CounterEnd < $MaxPage){
      ...
      // print " : ";
         echo "<a href='gw_history_detail.php?PageNo=$MaxPage&sort=$sort&how=$np&totalpages=$PageSize&criteria=$criteria&id=$id'>Last >></a>";
...
<p align="left"></td>
	...
	<p align="left"><font size="1" face="Verdana">(<a href='<?php echo $_SESSION["url"];?>'><img border="0" src="images/back_arrow.jpg" width="9" height="12"></a>
		<a style="text-decoration: none" href='<?php echo $_SESSION["url"];?>'>Back to 
					Graphical View</a>)</font></td>
		<td width="32%" align=center height="22" valign="top">
...
<br>
<div align="center">
<table width="95%" Border="1" class="NormalTableTwo" style="border-collapse: collapse" id="table14">
  <tr>
	...
	<a href="<?php echo $_SERVER["PHP_SELF"]."?page=gw_history_detail.php&PageNo=".$PageNo."&sort=source_user&totalpages=$PageSize&criteria=$criteria&id=$id&how=".$how; ?>" style="text-decoration: none">
    ...
    <td class="InternalHeader" width="4%" bgcolor="#E1ECF9"><center><B>
	<a href="<?php echo $_SERVER["PHP_SELF"]."?page=gw_history_detail.php&PageNo=".$PageNo."&sort=remote_user&totalpages=$PageSize&criteria=$criteria&id=$id&how=".$how; ?>" style="text-decoration: none">
	...
	<a href="<?php echo $_SERVER["PHP_SELF"]."?page=gw_history_detail.php&PageNo=".$PageNo."&sort=source_host&totalpages=$PageSize&criteria=$criteria&id=$id&how=".$how; ?>" style="text-decoration: none">
	<font size="1" face="Verdana" color="#000000">
	<img src='<?php 
    ...
    <td class="InternalHeader" width="20%" bgcolor="#E1ECF9"><center><B>
	<a href="<?php echo $_SERVER["PHP_SELF"]."?page=gw_history_detail.php&PageNo=".$PageNo."&sort=remote_host&totalpages=$PageSize&criteria=$criteria&id=$id&how=".$how; ?>" style="text-decoration: none">
	<font size="1" face="Verdana" color="#000000">
	<img src='<?php 
	...
	<a href="<?php echo $_SERVER["PHP_SELF"]."?page=gw_history_detail.php&PageNo=".$PageNo."&sort=gw_name&totalpages=$PageSize&criteria=$criteria&id=$id&how=".$how; ?>" style="text-decoration: none">
	<font size="1" face="Verdana" color="#000000">
	<img src='<?php 
    ...
    <td class="InternalHeader" width="5%" bgcolor="#E1ECF9"><center><B>
	<a href="<?php echo $_SERVER["PHP_SELF"]."?page=gw_history_detail.php&PageNo=".$PageNo."&sort=login&totalpages=$PageSize&criteria=$criteria&id=$id&how=".$how; ?>" style="text-decoration: none">
	<font size="1" face="Verdana" color="#000000">
	<img src='<?php 
	...
	<td class="InternalHeader" width="5%" bgcolor="#E1ECF9"><center><B>
	<a href="<?php echo $_SERVER["PHP_SELF"]."?page=gw_history_detail.php&PageNo=".$PageNo."&sort=logout&totalpages=$PageSize&criteria=$criteria&id=$id&how=".$how; ?>" style="text-decoration: none">
	<font size="1" face="Verdana" color="#000000">
	<img src='<?php 
    ...
    <td class="InternalHeader" width="5%" bgcolor="#E1ECF9"><center><B>
	<a href="<?php echo $_SERVER["PHP_SELF"]."?page=gw_history_detail.php&PageNo=".$PageNo."&sort=name&totalpages=$PageSize&criteria=$criteria&id=$id&how=".$how; ?>" style="text-decoration: none">
	<font size="1" face="Verdana" color="#000000">
    ...
    <td class="InternalHeader" width="5%" bgcolor="#E1ECF9"><center><B>
	<a href="<?php echo $_SERVER["PHP_SELF"]."?page=gw_history_detail.php&PageNo=".$PageNo."&sort=direction&totalpages=$PageSize&criteria=$criteria&id=$id&how=".$how; ?>" style="text-decoration: none">
	<font size="1" face="Verdana" color="#000000">
	<img src='<?php 
	...
	<td class="InternalHeader" width="5%" bgcolor="#E1ECF9"><center><B>
	<a href="<?php echo $_SERVER["PHP_SELF"]."?page=gw_history_detail.php&PageNo=".$PageNo."&sort=amd&totalpages=$PageSize&criteria=$criteria&id=$id&how=".$how; ?>" style="text-decoration: none">
	<font size="1" face="Verdana" color="#000000">
	<img src='<?php 
...
?>
  <tr bgcolor="<?php echo $bgCol;?>">
    ...
    <td class="NormalFieldTwo" width="20%"><font size="1" face="Verdana"><?php echo $row[8]; ?></font></td>
    <td class="NormalFieldTwo" width="20%"><font size="1" face="Verdana"><?php echo $row[10]; ?></font></td>
...
<br>
<table width="100%" border="0" class="InternalHeader" id="table15">
  <tr>
    <td>
