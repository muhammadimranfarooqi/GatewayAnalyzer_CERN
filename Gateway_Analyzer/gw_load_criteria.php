...
if (user_name=="" && destination_user_name=="" && source_host=="" && destination_host=="" && service=="Select" && direction=="Select" && am_status_code=="Select" && loginDate=="Select" && fromDate=="" && toDate=="" && logoutDate=="Select" &&logoutFromDate=="" && logoutToDate=="") {
...
<table border="0" width="100%" id="table1" height="322" cellspacing="0">
	...
	<tr>
		...
		<td width="83%" align=center height="21" valign="top">
           ...
           <form method="POST" action="gw_load.php" name="historyForm">
			...
			<tr>
				<td width="99%" height="28" colspan="2">
					<table border="0" width="100%" id="table24" cellspacing="3" cellpadding="2">
						<tr>
							<td width="19%"><font face="Verdana" size="1">Source User</font></td>
							<td width="27%" colspan="2">
							
							
								<p>
								<font face="Verdana" size="1">
								<input type="text" name="user_name" size="20"></font></p></td>
	...
	<tr>
		...
		<td width="83%" align=center height="21" valign="top">
           ...
           <b><font color="#008000" face="Verdana" size="2">Gateway Load for 
			current logins------- 
	...
	<tr>
		...
		$rs= $con->viewGatewayLoad("",$user_name,$destination_user_name,$source_host,$destination_host,$service,"Incoming",$am_status_code,"lastyear",$toDate,$logoutFromDate,$logoutToDate,"ON","gw_name",$cn);
...
$_SESSION['gw_url']="gw_load_criteria.php";
           ...
           <table border="1" width="90%" style="border-collapse: collapse" bordercolor="#D7D1E4" id="table25">
			<tr>
				<td colspan="2" background="images/15-green.jpg" height="23">
					<font size="1" face="Verdana"><b>
					Gateway Load Statistics&nbsp; </b></font></td>
			</tr>
			<tr>
...
No. of Users</font></b></td>
						...
						$link_text = $_SESSION["link_text"];
							...
							<tr>
								...
								<td align="left" width="35%"><font face="Verdana" size="2"><a href='gw_detail_load_graph.php?criteria=<?php echo "direction:Incoming,from:lastyear";?>&gw=<?php echo $row["gw_name"];?>'><?php echo $row["gw_name"];?></a></font></td>
