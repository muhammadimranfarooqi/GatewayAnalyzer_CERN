		...
		<table border="0" width="100%" id="table17" cellspacing="0">
			<tr>
				<td background="images/15-green.jpg" width="48%" height="28">
					...
					Gateway Load Statistics&nbsp; </b><font color="#008000">(</font></font><font size="1" face="Verdana" color="#008000">View 
					As :- </font>
					<a href="javascript:getProperGraph('pie_chart','gw_load')">
					<img border="0" src="images/chart_pie.png" width="16" height="16"></a><font size="1" face="Verdana" color="#008000"> 
					or </font>
					<a href="javascript:getProperGraph('bar_chart','gw_load')">
