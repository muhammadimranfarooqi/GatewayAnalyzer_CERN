...
$rs= $con->viewGatewayLoad($gateway_name,$user_name,$destination_user_name,$source_host,$destination_host,"",$direction,$am_status_code,$fromDate,$toDate,$logoutFromDate,$logoutToDate,$loginStatus,"services.name",$cn);
					...
					<div align="center">
						<table border="0" width="100%" id="table31" cellpadding="3">
							<tr>
								...
								<b><font face="Verdana" size="2">Service</font></b></td>
								<td align="center" width="50%" background="images/15.jpg" colspan="2">
							...
							<tr>
								...
								<td align="left" width="35%"><font face="Verdana" size="2"><a href="service_detail_load_graph.php?criteria=<?php echo $link_text;?>&sv=<?php if ($row["name"]=="") echo "Others"; else echo $row[name];?>"><?php if ($row["name"]=="") echo "Others"; else echo $row["name"];?></a></font></td>
